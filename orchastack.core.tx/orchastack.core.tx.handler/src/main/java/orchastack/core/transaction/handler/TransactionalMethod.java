...
public class TransactionalMethod implements MethodInterceptor {
	...
	private static Logger log = Logger.getLogger(TransactionalMethod.class.getName());
    ...
    public void onEntry() throws SystemException, NotSupportedException {
        ...
        synchronized (this) {
            if (this.manager != null) {
            	...
            	log.log(Level.WARNING,"cannot find TransactionManager, return do nothing---");
        ...
        switch (propagation) {
            case REQUIRES:
            	...
            	log.log(Level.INFO,"Transaction config is  REQUIRES---");
                ...
                break;
            case MANDATORY: 
            	log.log(Level.INFO,"Transaction config is  MANDATORY---");
                ...
                break;
            case SUPPORTED:
            	log.log(Level.INFO,"Transaction config is  SUPPORTED---");
                ...
                break;
            case NOT_SUPPORTED:
            	log.log(Level.INFO,"Transaction config is  NOT_SUPPORTED---");
                // Do nothing.
                break;
            case NEVER:
            	log.log(Level.INFO,"Transaction config is  NEVER---");
                if (transaction != null) {
                    throw new IllegalStateException("The method " + method + " must never be called inside a transaction");
                }
                break;
            case REQUIRES_NEW:
            	log.log(Level.INFO,"Transaction config is  REQUIRES_NEW---");
                if (transaction == null) {
