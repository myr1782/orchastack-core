 ...
 * default test system configuration.
 * <p>
 * We do not need the Remote Bundle Context for Native Container, and we prefer
 * unified logging with logback.
 * <p>
	...
	public static Option regressionDefaults(String unpackDir) {
		return composite(
				...
				karafDistributionConfiguration()
						...
						.unpackDirectory(
								unpackDir == null ? null : new File(unpackDir))
				...
				when(isEquinox()).useOptions(
						...
						systemProperty("osgi.console.enable.builtin").value(
								"true")));
	}
